 ...
 */
export declare function compose(...args: Array<((Comp: ComponentType<any>) => ComponentType<any>) | ContextInjectorResult<any, any>>): <P, R = P>(Comp: ComponentType<P>) => ComponentType<R>;
